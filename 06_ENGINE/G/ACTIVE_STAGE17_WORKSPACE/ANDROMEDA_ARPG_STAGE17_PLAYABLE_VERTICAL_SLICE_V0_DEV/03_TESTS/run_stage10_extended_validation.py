...
MASTER=os.environ.get('ANDROMEDA_MASTER_RELEASE','/mnt/data/ANDROMEDA_CODEX_MASTER_V2_0_1_RELEASE.zip'); REPORT=Path(__file__).resolve().parents[1]/'04_REPORTS'/'STAGE10_EXTENDED_VALIDATION_V1_0.json'
def systems(rt):
