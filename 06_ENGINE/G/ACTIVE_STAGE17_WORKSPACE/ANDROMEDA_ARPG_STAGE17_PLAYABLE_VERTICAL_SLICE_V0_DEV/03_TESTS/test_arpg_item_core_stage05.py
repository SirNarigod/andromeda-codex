...
class ItemStage05Tests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        receiver=cls.engine.arpg(cls.wid).create_profile('local:recv',origin_mode='CREATED',display_name='Receiver')['profile']
        cls.recv=receiver['profile_ref']; cls.items.ensure_inventory(cls.recv)
